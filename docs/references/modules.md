...
## adoption_templates.py

```python
_SPEC_SCAFFOLD: str
_DESIGN_SCAFFOLD: str
_PATTERNS_SCAFFOLD: str
_REFERENCES_MODULES_HEADER: str
_VERSION_BUMP_WORKFLOW: str
_VERSION_TAG_WORKFLOW: str
_GITLAB_VERSION_BUMP: str
_AGENTS_CONTENT: str
```
